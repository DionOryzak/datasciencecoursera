...
formula = LABEL+' ~ '
formula += ' + log_Revenue   + Revenue_missing  + log_MedefenseLimit'
...
prediction_glm = ml.GLM(data_train, CONTFEATURES,CATFEATURES,LABEL,EXPOSURE,formula,'medsev/',0,'gamma')
...
for feature in ALLCONTFEATURES:
	...
	ml.actualvsfittedbyfactor(data_train,feature+'Band','medsev/')

for feature in ALLCATFEATURES:
	ml.actualvsfittedbyfactor(data_train,feature,'medsev/')
